...
cup.to_csv('out/mouse_heart/pred_Associated_Index.csv', header=None, index=None)
...
cu.to_csv('out/mouse_heart/Prediction_Associated_all.csv', header=None, index=None)
...
curve.to_csv('out/mouse_heart/Associated_Index_out_pre_ture.csv', header=None, index=None)
