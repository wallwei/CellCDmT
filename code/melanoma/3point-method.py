...
cancer = r'GSE72056'  # File directory for cancer species
x_ytick = ['Melanoma cancer cells', 'T cells', 'B cells', 'Macrophages', 'Endothelial cells', 'CAFs','NK cells'] # Melanoma->0...NK->6
cell_type = 6  # Modify the number of cell types here, such as melanoma ->8, colorectal cancer ->9
...
# 保存图像为 PDF
plt.savefig('score1-net.pdf', dpi=1080, bbox_inches='tight')
...
# 保存图像为 PDF
plt.savefig('score2-net.pdf', dpi=1080, bbox_inches='tight')
...
# 保存图像为 PDF
plt.savefig('score3-net.pdf', dpi=1080, bbox_inches='tight')
...
#
# # 保存图像为 PDF
# plt.savefig('score4-net.pdf', dpi=1080, bbox_inches='tight')
#
# # 显示图形
# plt.show()
...
# 保存图像为 PDF
plt.savefig('score5-net.pdf', dpi=1080, bbox_inches='tight')
...
# 保存图像为 PDF
plt.savefig('score6-net.pdf', dpi=1080, bbox_inches='tight')
...
# 保存图像为 PDF
plt.savefig('score7-net.pdf', dpi=1080, bbox_inches='tight')
...
# 保存图像为 PDF
plt.savefig('score8-net.pdf', dpi=1080, bbox_inches='tight')
...
#
# # 保存图像为 PDF
# plt.savefig('score9-net.pdf', dpi=1080, bbox_inches='tight')
#
# # 显示图形
# plt.show()
#
...
#
# # 保存图像为 PDF
# plt.savefig('score10-net.pdf', dpi=1080, bbox_inches='tight')
#
# # 显示图形
# plt.show()
#
...
#
# # 保存图像为 PDF
# plt.savefig('score11-net.pdf', dpi=1080, bbox_inches='tight')
#
# # 显示图形
# plt.show()
...
# 保存图像为 PDF
plt.savefig('score12-net.pdf', dpi=1080, bbox_inches='tight')
...
#
# # 保存图像为 PDF
# plt.savefig('score13-net.pdf', dpi=1080, bbox_inches='tight')
#
# # 显示图形
# plt.show()
#
...
#
# # 保存图像为 PDF
# plt.savefig('score14-net.pdf', dpi=1080, bbox_inches='tight')
#
# # 显示图形
# plt.show()
#
...
#
# # 保存图像为 PDF
# plt.savefig('score15-net.pdf', dpi=1080, bbox_inches='tight')
#
# # 显示图形
# plt.show()
#
...
#
# # 保存图像为 PDF
# plt.savefig('score16-net.pdf', dpi=1080, bbox_inches='tight')
#
# # 显示图形
# plt.show()
