...
# -----------------------------------------------
cancer = r'GSE103322'  # File directory
cell_type = 8   # Modify the number of cell types here, such as melanoma ->6, colorectal cancer ->7
...
for i in range(0, cell_type + 1):
    for j in range(0, cell_type + 1):
        if (i == 0 and j != 0) or (i != 0 and j == 0):
            ...
            list2 = pd.read_csv(cancer + "spec_list" + str(i) + str(j) + ".csv",header=None, index_col=None)
