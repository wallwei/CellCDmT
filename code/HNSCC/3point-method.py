...
folders_to_create = [
    r"HNSCC\expression_thresholding",
    r"HNSCC\expression_product",
    r"HNSCC\cell_expression",
    r"HNSCC\Three",
    r"HNSCC\Three\TOP",
    r"HNSCC"]
for folder in folders_to_create:
    os.makedirs(folder, exist_ok=True)
cancer = r'HNSCC_'  # File directory for cancer species
x_ytick = ['HNSCC cells', 'Fibroblasts', 'B cells', 'Myocytes',  'Macrophages','Endothelial cells', 'T cells','Dendritic cells', 'Mast cells'] # Melanoma->0...NK->6
cell_type = 8  # Modify the number of cell types here, such as melanoma ->8, colorectal cancer ->9

def min_max_scaling(data):
    return (data - data.min()) / (data.max() - data.min())


thrd = pd.read_csv(cancer + "thrdy_score.csv", header=None, index_col=None).to_numpy()
thrdy = min_max_scaling(thrd)
result1 = pd.DataFrame(thrdy)

pro = pd.read_csv(cancer + "multy_score.csv", header=None,index_col=None).to_numpy()
proy = min_max_scaling(pro)
result2 = pd.DataFrame(proy)

spec = pd.read_csv(cancer + "specy_score.csv", header=None,index_col=None).to_numpy()
specy = min_max_scaling(spec)
result3 = pd.DataFrame(specy)

total = pd.read_csv(cancer + "total_score.csv", header=None,index_col=None).to_numpy()
totaly = min_max_scaling(total)
result4 = pd.DataFrame(totaly)

reg_prod = pd.read_csv(cancer + "reg_prod_score.csv", header=None,index_col=None).to_numpy()
...
# 保存图像为 PDF
plt.savefig('HNSCC\\score1-net.pdf', dpi=1080, bbox_inches='tight')
...
# 保存图像为 PDF
plt.savefig('HNSCC\\score2-net.pdf', dpi=1080, bbox_inches='tight')
...
# 保存图像为 PDF
plt.savefig('HNSCC\\score3-net.pdf', dpi=1080, bbox_inches='tight')
...
# 保存图像为 PDF
plt.savefig('HNSCC\\score4-net.pdf', dpi=1080, bbox_inches='tight')
...
# 保存图像为 PDF
plt.savefig('HNSCC\\score5-net.pdf', dpi=1080, bbox_inches='tight')
...
# 保存图像为 PDF
plt.savefig('HNSCC\\score6-net.pdf', dpi=1080, bbox_inches='tight')
...
# 保存图像为 PDF
plt.savefig('HNSCC\\score7-net.pdf', dpi=1080, bbox_inches='tight')
...
# 保存图像为 PDF
plt.savefig('HNSCC\\score8-net.pdf', dpi=1080, bbox_inches='tight')
...
# 保存图像为 PDF
plt.savefig('HNSCC\\score9-net.pdf', dpi=1080, bbox_inches='tight')
...
# 保存图像为 PDF
plt.savefig('HNSCC\\score10-net.pdf', dpi=1080, bbox_inches='tight')
...
# 保存图像为 PDF
plt.savefig('HNSCC\\score11-net.pdf', dpi=1080, bbox_inches='tight')
...
# 保存图像为 PDF
plt.savefig('HNSCC\\score12-net.pdf', dpi=1080, bbox_inches='tight')
...
# 保存图像为 PDF
plt.savefig('HNSCC\\score13-net.pdf', dpi=1080, bbox_inches='tight')
...
# 保存图像为 PDF
plt.savefig('HNSCC\\score14-net.pdf', dpi=1080, bbox_inches='tight')
