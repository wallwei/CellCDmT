...
dataname = 'human'
path= "/data/wuwei/LRI-CNbDF/dataset/"
...
cup.to_csv('out/human/pred_Associated_Index.csv', header=None, index=None)
...
cu.to_csv('out/human/Prediction_Associated_all.csv', header=None, index=None)
...
curve.to_csv('out/human/Associated_Index_out_pre_ture.csv', header=None, index=None)
