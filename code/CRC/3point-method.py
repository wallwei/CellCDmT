...
folders_to_create = [
    r"CRC\expression_thresholding",
    r"CRC\expression_product",
    r"CRC\cell_expression",
    r"CRC\Three",
    r"CRC\Three\TOP",
    r"CRC"]
...
cell_type = 7  # Modify the number of cell types here, such as melanoma ->8, colorectal cancer ->9
