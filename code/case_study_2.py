...
cup.to_csv('out/mouse/pred_Associated_Index.csv', header=None, index=None)
...
cu.to_csv('out/mouse/Prediction_Associated_all.csv', header=None, index=None)
...
curve.to_csv('out/mouse/Associated_Index_out_pre_ture.csv', header=None, index=None)
